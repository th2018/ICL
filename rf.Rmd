...
```{r}
# read data
usgs<-read.csv("C:/Users/taohuang/Downloads/ICL-main(1)/ICL-main/wt_ID.csv") #DRAIN_SQKM
...
```{r}
# read data
usgs<-read.dbf("C:/Users/taohuang/Documents/Tao/Data/norwest/usgs_wt_ID_nearest.dbf") #DRAIN_SQKM
