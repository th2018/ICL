...
save(meanAugT_df,file="C:/Users/taohuang/Downloads/ICL-main/meanQT_13_21.Rdata")
...
set.seed(101)
train2 = sample(1:nrow(meanAugT_all_mo3),  nrow(meanAugT_all_mo3)*0.9 )
dim(meanAugT_all_mo3)
length(train2)
...
rf.stream_T2 = randomForest(monthly_stream_T ~ ele +monthly_stream_Q   +monthly_air_T , data = meanAugT_all_mo3, subset = train2)
rf.stream_T2
