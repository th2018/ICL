...
```{r}
set.seed(101)
train = sample(1:nrow(meanAugT_all_mo),  nrow(meanAugT_all_mo)*0.9 )
dim(meanAugT_all_mo)
length(train)

set.seed(101)
train2 = sample(1:nrow(meanAugT_all_mo2),  nrow(meanAugT_all_mo2)*0.9 )
dim(meanAugT_all_mo2)
length(train2)

set.seed(101)
train3 = sample(1:nrow(meanAugT_all_mo3),  nrow(meanAugT_all_mo3)*0.9 )
dim(meanAugT_all_mo3)
length(train3)


set.seed(101)
train4 = sample(1:nrow(meanAugT_all_mo4),  nrow(meanAugT_all_mo4)*0.9 )
...
plot(meanAugT_all_mo3[-train3,]$monthly_stream_T,predictions3 ,xlim=c(16,26) ,ylim=c(16,26) , xlab="Observed stream temperature (degC)", ylab="Predicted stream temperature (degC)", main="No dam")
```
...
plot(meanAugT_all_mo4[-train4,]$monthly_stream_T,predictions4 ,xlim=c(16,22) ,ylim=c(16,22) , xlab="Observed stream temperature (degC)", ylab="Predicted stream temperature (degC)" , main="Dam")
```
