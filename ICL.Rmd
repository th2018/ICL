...
<!-- ```{r} -->
<!-- c<-read.csv("2506773.csv") -->
<!-- c<-c[!is.na(c$PRCP),] -->
<!-- head(c) -->
<!-- c$NAME -->

<!-- c$NAME<-as.character(c$NAME ) -->
<!-- c<-c[ c$NAME=="PELTON DAM, OR US",] -->
<!-- str(c) -->

<!-- c$DATE<-as.character(c$DATE) -->
<!-- c$DATE<-as.POSIXct(as.character(c$DATE), format="%Y-%m-%d") -->
<!-- head(c) -->
<!-- c$wyr<-0 -->

<!-- c[c$DATE>= as.POSIXct("2009-10-01" , format="%Y-%m-%d") & c$DATE< as.POSIXct("2010-10-01" , format="%Y-%m-%d") ,]$wyr<-2010 -->
<!-- c[c$DATE>= as.POSIXct("2010-10-01" , format="%Y-%m-%d") & c$DATE< as.POSIXct("2011-10-01" , format="%Y-%m-%d") ,]$wyr<-2011 -->
<!-- c[c$DATE>= as.POSIXct("2011-10-01" , format="%Y-%m-%d") & c$DATE< as.POSIXct("2012-10-01" , format="%Y-%m-%d") ,]$wyr<-2012 -->
<!-- c[c$DATE>= as.POSIXct("2012-10-01" , format="%Y-%m-%d") & c$DATE< as.POSIXct("2013-10-01" , format="%Y-%m-%d") ,]$wyr<-2013 -->
<!-- c[c$DATE>= as.POSIXct("2013-10-01" , format="%Y-%m-%d") & c$DATE< as.POSIXct("2014-10-01" , format="%Y-%m-%d") ,]$wyr<-2014 -->

<!-- c$wyr <-as.factor(c$wyr ) -->

<!-- max_rain<-aggregate( c$PRCP ,list( c$wyr ),max)  -->
<!-- max_rain -->

<!-- mean_rain<-aggregate( c$PRCP ,list( c$wyr ),mean)  -->
<!-- mean_rain -->

<!-- #mean_rain<-aggregate( c$PRCP ,list( c$wy ),mean)  #in millimeters to tenths. -->
<!-- #colnames(mean_rain)<-c("wyr","mean_rain") -->

<!-- ``` -->

<!-- ```{r} -->
<!-- hist(c$PRCP) -->
<!-- hist(c[c$wyr==2013,]$PRCP) -->
<!-- hist(c[c$wyr==2014,]$PRCP) -->

<!-- plot(c[c$wyr==2011,]$DATE,c[c$wyr==2011,]$PRCP) -->
<!-- plot(c[c$wyr==2013,]$DATE,c[c$wyr==2013,]$PRCP) -->
<!-- plot(c[c$wyr==2014,]$DATE,c[c$wyr==2014,]$PRCP) -->
<!-- ``` -->
